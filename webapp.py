...
import os
import numpy as np
working_dir = os.getcwd()+'\\model_&_scaler\\'
...
model_diabetes = pickle.load(open(f'{working_dir}diabetes_model.pkl','rb'))
scaler_diabe1tes = pickle.load(open(f'{working_dir}diabetes_scaler.pkl','rb'))

model_hypertension = pickle.load(open(f'{working_dir}Hypertension_model.pkl','rb'))
scaler_hypertension = pickle.load(open(f'{working_dir}Hypertension_scaler.pkl','rb'))

model_lungcancer = pickle.load(open(f'{working_dir}lung_cancer_model.pkl','rb'))
scaler_lungcaner = pickle.load(open(f'{working_dir}lung_cancer_scaler.pkl','rb'))
